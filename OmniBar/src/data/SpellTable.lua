...
addon.spellTable = { 
    ...
    ["Hunter"] = {
        ...
        ["Disengage"] = { isTracking = false, duration = 16, spellId = 61507 },
    ...
    ["Paladin"] = {
        ...
        ["Judgement of Light"] = { isTracking = false, duration = 10, spellId = 20271, adjust = { protPala = 8, retri = 8 } },
        ["Judgement of Justice"] = { isTracking = false, duration = 10, spellId = 20184, adjust = { protPala = 8, retri = 8 } },
        ["Judgement of Wisdom"] = { isTracking = false, duration = 10, spellId = 53408, adjust = { protPala = 8, retri = 8 } },
