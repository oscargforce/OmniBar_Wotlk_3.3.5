...
function CreateOmniBarWidget(barKey, barSettings)
    ...
    local function CreateOmniBarIcon(iconPath)
        ...
        targetHighlight:SetSize(72, 70)
        targetHighlight:SetPoint("CENTER", button, "CENTER", 0, -1)
        ...
        focusHighlight:SetSize(72, 70)
        focusHighlight:SetPoint("CENTER", button, "CENTER", 0, -1)
